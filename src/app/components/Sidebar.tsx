...
export const Sidebar = () => {
    return (
        <div id="menu" style={{ width: '500px' }} className="bg-gray-900 min-h-screen z-10 text-slate-300 w-64 left-0  overflow-y-scroll">
                ...
                <a href="#" className="inline-flex space-x-2 items-center">
                    <span>
                        <Image width={100} height={100}
                            ...
                            src="https://avatars.githubusercontent.com/u/88678618?s=400&u=e1a1c431706193dfd36efd7e739c73cf14163d31&v=4" alt="User Avatar" />
                    </span>
